...
{
    enum ref_state              ref_state;                  // Reference state control
...
= {// "Signal name"      type,         max_n_els, *enum,                         *value,            num_defaults,cyc_sel_step,flags
    { "REF_STATE",       PAR_ENUM,     1,          enum_state_ref,        { .u = &ccpars_global.ref_state        }, 1, 0, PARS_RW|PARS_CFG          },
